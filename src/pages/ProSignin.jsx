        ...
        <div className="w-full max-w-4xl flex overflow-hidden rounded-2xl shadow-xl">
                ...
                <div className="h-full flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-white/90 mb-8">
                            Créez votre compte "professionel de santé" pour sauver des vies.
                        </p>
                    </div>
                    <div>
            ...
            <div className="w-full md:w-3/5 bg-white p-8">
                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold text-[#F05050] mb-2">Se connecter en tant que professionel de santé </h1>
           ...
           {/*      <a href="/ProS" className="text-[#F05050] hover:underline font-medium">
                        lancer ProS
                    </a>*/}
