  ...
  const DeviceConnectionStatus = () => {
    return (
      <div className={`${isDark ? "bg-gray-800" : "bg-white"} rounded-lg shadow-md p-6 mb-6`}>
        <h3 className="text-lg font-semibold mb-4 text-gray-800">Appareils Connectés</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium">Montre Connectée</span>
              </div>
              <div
            ...
            >
              {deviceConnections.smartwatch.connected ? "Déconnecter" : "Connecter"}
            </button>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            ...
            >
              {deviceConnections.cgm.connected ? "Déconnecter" : "Connecter"}
            </button>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            ...
            >
              {deviceConnections.vehicle.connected ? "Déconnecter" : "Connecter"}
            </button>
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          {globalAlertStatus.activeAlerts.length > 0 && (
            <div className="flex items-center space-x-2">
              <div
                className={`px-2 py-1 rounded-full text-xs font-medium ${config.bgColor} border ${config.borderColor}`}
              >
                <span className={config.textColor}>
                  {globalAlertStatus.activeAlerts.length} Alert{globalAlertStatus.activeAlerts.length > 1 ? "s" : ""}
                </span>
              </div>
          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-800">Fréquence Cardiaque</h3>
                    <div
                      className="px-2 py-1 rounded-full text-xs font-medium"
                      style={{
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-800">Tension Artérielle</h3>
                    <div
                      className="px-2 py-1 rounded-full text-xs font-medium"
                      style={{
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-gray-800">Saturation en Oxygène</h3>
                    <div
                      className="px-2 py-1 rounded-full text-xs font-medium"
                      style={{
